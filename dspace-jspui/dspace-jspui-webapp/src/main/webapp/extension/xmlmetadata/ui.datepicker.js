...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		clearText: '清除', //'Clear', // Display text for clear link
		clearStatus: '清除現在的日期', //'Erase the current date', // Status text for clear link
		closeText: '關閉', //'Close', // Display text for close link
		closeStatus: '關閉不變更', //'Close without change', // Status text for close link
		prevText: '&#x3c;上月', //'&#x3c;Prev', // Display text for previous month link
		prevStatus: '顯示上一個月', //'Show the previous month', // Status text for previous month link
		nextText: '下月&#x3e;', //'Next&#x3e;', // Display text for next month link
		nextStatus: '顯示下一個月', //'Show the next month', // Status text for next month link
		currentText: '今天', //'Today', // Display text for current month link
		currentStatus: '顯是現在的月份', //'Show the current month', // Status text for current month link
		monthNames: ['一月','二月','三月','四月','五月','六月','七月','八月','九月','十月',
					 '十一月','十二月'], //['January','February','March','April','May','June',
			//'July','August','September','October','November','December'], // Names of months for drop-down and formatting
		monthNamesShort: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'], // For formatting
		monthStatus: '顯示不同的月份', //'Show a different month', // Status text for selecting a month
		yearStatus: '顯示不同的年份', //'Show a different year', // Status text for selecting a year
		weekHeader: '週', //'Wk', // Header for the week of the year column
